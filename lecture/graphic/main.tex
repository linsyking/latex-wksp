...
There may be a lecture about \packagename{tikz} and \packagename{pgf} in the future. If you are now interested in it, please refer to the \structure{pgf manual} by \mintinline{shell}|texdoc tikz| or \mintinline{shell}|texdoc pgf|.
